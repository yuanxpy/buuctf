...
#这里的edit4是因为atoi本身以8结尾但是chunk0本身已经是8结尾了，edit检测到chunk0后会对其进行修改后直接退出，不会修改atoi
#所以取atoi_got-4，这里取-1到-7都行，因为&0xFFFFFFFFFFFFFFF0后都一样都是atoi_got - 0x8，类似上面的原理需要edit两个system地址
#不能取-8，因为chunk1已经delete，为0，改成-8后edit会优先检测到chunk1
